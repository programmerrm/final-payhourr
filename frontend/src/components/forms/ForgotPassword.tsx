...
export const ForgotPasswordForm: React.FC = () => {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmitForm)}>
            <div className="flex flex-col flex-wrap gap-y-1.5 mb-4">
            ...
            <button disabled={isLoading} type="submit" className="w-full bg-black text-white text-sm md:text-base font-medium px-10 py-3.5 rounded-xl cursor-pointer hover:bg-gray-800 transition">{isLoading ? "Processing..." : "Send Reset Link"}</button>
        </form>
    );
}
