...
export const BuyerDashboard: React.FC = () => {
    ...
    return (
        <div className="tab-content flex-grow overflow-y-scroll lg:overflow-hidden scrollbar-hidden">
            <div className="flex flex-col lg:flex-row gap-3 xl:gap-6 lg:h-full">
                <div className="grow grid grid-cols-[repeat(auto-fit,_minmax(170px,_1fr))] xl:grid-cols-[repeat(auto-fit,_minmax(260px,_1fr))] gap-5 overflow-y-auto scrollbar-hidden content-stretch">
                ...
                <div className="w-auto border border-gray-300 rounded-2xl shadow-md bg-white shrink-0 flex flex-col overflow-scroll scrollbar-hidden">
                    ...
                    {data?.data?.length > 0 ? (
                        data.data.map((txn: any, index: number) => (
                            <div
                                key={index}
                                className="grid grid-cols-4 text-center divide-x divide-gray-200 border-t border-gray-200 border-b text-sm text-gray-600 hover:bg-gray-50 transition"
                            >
                                <p className="p-3 ">
