        ...
        <div className="tab-content flex-grow overflow-auto flex flex-col lg:flex-row gap-6">
            <div className="flex-grow grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 content-start">
                <div className="bg-white p-2.5 md:p-3 lg:p-6 border border-gray-300 rounded-2xl shadow-md text-center hover:shadow-xl transition-all duration-300 flex items-center justify-center flex-col">
                    <h2 className="text-base lg:text-xl font-semibold text-gray-800">Total Earning</h2>
                    <p className="mt-2 text-base lg:text-3xl font-extrabold text-blue-600">15,400</p>
                </div>
                <div className="bg-white p-2.5 md:p-3 lg:p-6 border border-gray-300 rounded-2xl shadow-md text-center hover:shadow-xl transition-all duration-300">
                    <h2 className="text-base lg:text-xl font-semibold text-gray-800">Total Transactions</h2>
                    <p className="mt-2 text-base lg:text-3xl font-extrabold text-green-600">12</p>
                </div>
                <div className="bg-white p-2.5 md:p-3 lg:p-6 border border-gray-300 rounded-2xl shadow-md text-center hover:shadow-xl transition-all duration-300">
                    <h2 className="text-base lg:text-xl font-semibold text-gray-800">My Connected Buyer</h2>
                    <p className="mt-2 text-base lg:text-3xl font-extrabold text-yellow-600">3</p>
                </div>
                <div className="bg-white p-2.5 md:p-3 lg:p-6 border border-gray-300 rounded-2xl shadow-md text-center hover:shadow-xl transition-all duration-300">
                ...
                <div className="bg-white p-2.5 md:p-3 lg:p-6 border border-gray-300 rounded-2xl shadow-md text-center hover:shadow-xl transition-all duration-300">
                    <h2 className="text-base lg:text-xl font-semibold text-gray-800">Total Dispute</h2>
                    <p className="mt-2 text-base lg:text-3xl font-extrabold text-indigo-600">84</p>
                </div>
                <div className="bg-white p-2.5 md:p-3 lg:p-6 border border-gray-300 rounded-2xl shadow-md text-center hover:shadow-xl transition-all duration-300">
                    <h2 className="text-base lg:text-xl font-semibold text-gray-800">Pending Orders</h2>
            ...
            <div className="w-full lg:w-[30%] border border-gray-300 rounded-2xl shadow-md bg-white shrink-0 flex flex-col">
                <h2 className="p-4 border-b border-gray-300 text-base lg:text-xl font-semibold text-center text-black bg-gray-100 rounded-t-2xl">Network Updates</h2>
