                ...
                <div className="max-w-screen-2xl conatiner mx-auto px-2.5 lg:px-5 w-full">
                    <div className="flex flex-col w-full pt-10 pb-4">
                        <div className="flex flex-col w-full">
                            <div className="flex flex-col gap-y-8 w-full h-full">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-5 gap-y-10">
                                    <div className="flex flex-col gap-y-6 text-black text-xl font-normal capitalize">
                                        ...
                                        <ul className="space-y-1.5 font-medium text-base">
                                            <li>
                                                <Link className="inline-block transition-all duration-300 ease-linear hover:translate-x-[10px]" to="/what-is-payhourr/">
                                                    What is PayHourr?
                                                </Link>
                                            </li>
                                            <li>
                                                <Link className="inline-block transition-all duration-300 ease-linear hover:translate-x-[10px]" to="/why-use-payhourr/">
                                                    Why Use PayHourr?
                                                </Link>
                                            </li>
                                            <li>
                                                <Link className="inline-block transition-all duration-300 ease-linear hover:translate-x-[10px]" to="/our-mission/">
                                                    Our Mission
                                                </Link>
                                            </li>
                                            <li>
                                                <Link className="inline-block transition-all duration-300 ease-linear hover:translate-x-[10px]" to="/contact/">
                                                    Contact
                                                </Link>
                                            </li>
                                        </ul>
                                    ...
                                    <div className="flex flex-col gap-y-6 text-black text-xl font-normal capitalize">
                                        ...
                                        <ul className="space-y-1.5 font-medium text-base">
                                            <li>
                                                <Link className="inline-block transition-all duration-300 ease-linear hover:translate-x-[10px]" to="/buyer-guide/">
                                                    Buyer Guide{" "}
                                                </Link>
                                            </li>
                                            <li>
                                                <Link className="inline-block transition-all duration-300 ease-linear hover:translate-x-[10px]" to="/seller-guide/">
                                                    Seller Guide{" "}
                                                </Link>
                                            </li>
                                            <li>
                                                <Link className="inline-block transition-all duration-300 ease-linear hover:translate-x-[10px]" to="/secure-payment-process/">
                                                    Secure Payment Process{" "}
                                                </Link>
                                            </li>
                                            <li>
                                                <Link className="inline-block transition-all duration-300 ease-linear hover:translate-x-[10px]" to="/faq/">
                                                    FAQ
                                                </Link>
                                            </li>
                                        </ul>
                                    ...
                                    <div className="flex flex-col gap-y-6 text-black text-xl font-normal capitalize">
                                        ...
                                        <ul className="space-y-1.5 font-medium text-base">
                                            <li>
                                                <Link className="inline-block transition-all duration-300 ease-linear hover:translate-x-[10px]" to="/terms-of-services/">
                                                    Terms of Service{" "}
                                                </Link>
                                            </li>
                                            <li>
                                                <Link className="inline-block transition-all duration-300 ease-linear hover:translate-x-[10px]" to="/privacy-policy/">
                                                    Privacy Policy{" "}
                                                </Link>
                                            </li>
                                            <li>
                                                <Link className="inline-block transition-all duration-300 ease-linear hover:translate-x-[10px]" to="/dispute-policy/">
                                                    Dispute Policy{" "}
                                                </Link>
                                            </li>
                                            <li>
                                                <Link className="inline-block transition-all duration-300 ease-linear hover:translate-x-[10px]" to="/refund-policy/">
                                                    Refund Policy{" "}
                                                </Link>
                                            </li>
                                        </ul>
                                        ...
                                        <ul className="space-y-2.5 font-medium text-base">
                                            ...
                                            <li>
                                                <form action="" className="flex border-2 border-black rounded-lg mt-2">
                                                    ...
                                                    <button className="py-2.5 px-4 bg-black rounded text-white text-xl font-medium cursor-pointer shrink-0" type="submit">
                                                        Subscribe
                                                    </button>
                                                </form>
                                            </li>
                            ...
                            <Link className="inline-flex items-center justify-center mt-5" to="#">
                                <img className="w-full md:w-[60%]" src={SSL} alt="" />
                            </Link>
                        </div>
                        <div className="flex flex-row flex-wrap justify-between items-center w-full text-black mt-10 md:mt-20 gap-5">
                            <p className="text-base font-normal">
