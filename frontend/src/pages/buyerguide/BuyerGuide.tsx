...
import { useGetBuyerGuideQuery } from "../../redux/features/configuration/configurationApi";

export default function BuyerGuide() {
    const { data } = useGetBuyerGuideQuery(undefined, { refetchOnMountOrArgChange: true });
    return (
