...
import { useGetSecurePaymentProcessQuery } from "../../redux/features/configuration/configurationApi";

export default function SecurePaymentProcess() {
    const { data } = useGetSecurePaymentProcessQuery(undefined, { refetchOnMountOrArgChange: true });
    return (
