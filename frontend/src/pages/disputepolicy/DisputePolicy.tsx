...
import { useGetDisputePolicyQuery } from "../../redux/features/configuration/configurationApi";

export default function DisputePolicy() {
    const { data } = useGetDisputePolicyQuery(undefined, { refetchOnMountOrArgChange: true });
    return (
