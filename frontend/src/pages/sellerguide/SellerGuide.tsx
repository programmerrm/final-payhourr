...
import { useGetSellerGuideQuery } from "../../redux/features/configuration/configurationApi";
import { MEDIA_URL } from "../../utils/Api";

export default function SellerGuide() {
  const { data } = useGetSellerGuideQuery(undefined, { refetchOnMountOrArgChange: true });
  return (
