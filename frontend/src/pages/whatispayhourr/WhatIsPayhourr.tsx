...
import { useGetWhatIsPayhourrQuery } from "../../redux/features/configuration/configurationApi";
import { MEDIA_URL } from "../../utils/Api";

export default function WhatIsPayhourr() {
    const { data } = useGetWhatIsPayhourrQuery(undefined, { refetchOnMountOrArgChange: true });
    return (
