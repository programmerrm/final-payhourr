            ...
            <div className="max-w-screen-2xl mx-auto px-2.5 lg:px-5 w-full h-full">
                <div className="relative z-20 flex flex-col items-center justify-center gap-y-6 md:gap-y-14 h-full text-white">
                    ...
                    <div className="flex flex-row flex-wrap justify-center items-center gap-x-5 md:gap-x-10 w-full">
                        ...
                        <Link className="text-base md:text-lg font-medium py-2.5 md:py-3.5 px-10 md:px-16 rounded bg-[#ED1B24]/70 transition-all ease-linear duration-300 hover:bg-[#1F2942]" to={"/"}>Buyer</Link>
                        <Link className="text-base md:text-lg font-medium py-2.5 md:py-3.5 px-10 md:px-16 rounded bg-[#1F2942]/70 transition-all ease-linear duration-300 hover:bg-[#ED1B24]" to={"/"}>Seller</Link>
