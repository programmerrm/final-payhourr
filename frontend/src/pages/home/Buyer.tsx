...
export const Buyer: React.FC = () => {
    return (
        <section className="bg-no-repeat bg-right-top bg-cover lg:bg-center py-8 lg:py-10 lg:min-h-screen flex items-center" style={{ backgroundImage: `url(${BuyerBg})` }}>
            <div className="max-w-screen-2xl container mx-auto px-2.5 lg:px-5 flex items-center gap-5 flex-col-reverse lg:flex-row">
                <div className="lg:w-1/2 space-y-2.5 md:space-y-3">
                    ...
                    <button className="inline-block py-2.5 px-4 rounded text-white text-sm md:text-base font-medium bg-red-500 transition-all ease-in duration-300 hover:bg-[#001429]" type="button">Become a Buyer</button>
                </div>
