...
import { useGetRefundPolicyQuery } from "../../redux/features/configuration/configurationApi";

export default function RefundPolicy() {
    const { data } = useGetRefundPolicyQuery(undefined, { refetchOnMountOrArgChange: true });
    return (
